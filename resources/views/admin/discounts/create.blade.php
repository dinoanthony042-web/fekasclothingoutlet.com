...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900">Create Flash Sale Discount</h1>
        ...
        <form method="POST" action="{{ route('admin.discounts.store') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="e.g., Summer Flash Sale" required
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="3"
                              placeholder="Describe the discount campaign"
                            ...
                            <div>
                                <label for="product_id" class="block text-sm font-medium text-gray-600 mb-2">
                                    <input type="radio" name="apply_to" id="product_id" value="product"
                                           onchange="toggleApplyTo()" {{ old('apply_to') == 'product' ? 'checked' : '' }}>
                                    <span class="ml-2">Specific Product</span>
                                </label>
                                <select name="product_id" id="product_select"
                                        class="ml-6 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                        {{ old('apply_to') == 'product' ? '' : 'disabled' }}>
                ...
                <div>
                    <label for="is_active" class="flex items-center text-sm font-medium text-gray-700 mt-6">
                        ...
                        <span class="ml-2">Activate Discount Immediately</span>
                    </label>
                </div>
            </div>
