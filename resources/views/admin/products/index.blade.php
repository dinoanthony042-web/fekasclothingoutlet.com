                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                {{ $product->is_featured ? 'bg-purple-100 text-purple-800' :
                                   ($product->is_new ? 'bg-green-100 text-green-800' :
                                   ($product->is_best_seller ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800')) }}">
