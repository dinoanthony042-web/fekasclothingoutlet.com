...
@section('content')
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-900">Create Hero Slider</h1>
    <p class="mt-1 text-sm text-gray-600">Add a new image to your hero slider</p>
</div>

<form method="POST" action="{{ route('admin.sliders.store') }}" enctype="multipart/form-data" class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
    @csrf
    ...
    <div class="space-y-6">
        ...
        <div class="border-b border-gray-200 pb-6">
            ...
            <!-- Image Upload -->
            <div>
                <label for="image_upload" class="block text-sm font-medium text-gray-900">Upload Images <span class="text-red-600">*</span></label>
                <div class="mt-2">
                ...
                <p class="mt-1 text-xs text-gray-600">Supported formats: JPG, JPEG, PNG, GIF, WebP (Max 5MB each)</p>
                @error('image_upload')
            ...
            <div id="preview-container" class="mt-6">
                ...
                <p id="no-images" class="text-sm text-gray-500">No images selected yet</p>
            </div>
        </div>
        ...
        <div class="border-b border-gray-200 pb-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="title" name="title" value="{{ old('title') }}" placeholder="e.g., Summer Collection"
            ...
            <div class="mb-4">
                ...
                <input type="text" id="subtitle" name="subtitle" value="{{ old('subtitle') }}" placeholder="e.g., Discover New Styles"
                    class="mt-2 block w-full rounded-lg border border-gray-300 px-4 py-2 text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                @error('subtitle')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                ...
                <textarea id="description" name="description" rows="4" placeholder="Enter slider description..."
                    class="mt-2 block w-full rounded-lg border border-gray-300 px-4 py-2 text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="border-b border-gray-200 pb-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="cta_text" name="cta_text" value="{{ old('cta_text') }}" placeholder="e.g., Shop Now"
                    class="mt-2 block w-full rounded-lg border border-gray-300 px-4 py-2 text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                @error('cta_text')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                ...
                <input type="url" id="cta_url" name="cta_url" value="{{ old('cta_url') }}" placeholder="https://example.com/collection"
                    class="mt-2 block w-full rounded-lg border border-gray-300 px-4 py-2 text-gray-900 placeholder-gray-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                @error('cta_url')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
